...
import { updateOrganizations } from "../graphql/mutations";
...
export default function OrganizationsUpdateForm(props) {
  ...
  React.useEffect(() => {
      ...
      const record = emailProp
        ? (
            await client.graphql({
              query: getOrganizations.replaceAll("__typename", ""),
    ...
    queryData();
  }, [emailProp, organizationsModelProp]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateOrganizations.replaceAll("__typename", ""),
            variables: {
              input: {
                email: organizationsRecord.email,
                ...modelFields,
              },
            },
          });
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(emailProp || organizationsModelProp)}
