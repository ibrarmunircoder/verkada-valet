...
const navLinks = [
  { label: 'Current Tickets', href: '/users/tickets', content: null },
  { label: 'Ticket History', href: '/users/tickets-history', content: null },
  { label: 'Add Car', href: '/users/add-new-car', content: null },
];
